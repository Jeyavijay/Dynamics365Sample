...
import { ProductSpecificationTableRow } from './components/nutrition-box-product-specification-table-stucture';
import { INutritionBoxProductSpecificationData } from './nutrition-box-product-specification.data';
import { displayStyle, INutritionBoxProductSpecificationProps } from './nutrition-box-product-specification.props.autogenerated';
 ...
 */
export interface IProductSpecificationViewProps extends INutritionBoxProductSpecificationProps<{}> {
 ...
 */
export interface IProductSpecificationExtentedProps extends INutritionBoxProductSpecificationProps<INutritionBoxProductSpecificationData> {
 ...
 * @extends {React.Component<INutritionBoxProductSpecificationProps<INutritionBoxProductSpecificationData>>}
 */
@observer
class ProductSpecification extends React.Component<IProductSpecificationExtentedProps, IProductSpecificationState> {
    ...
    public render(): JSX.Element | null {
        let data: INutritionBoxProductSpecificationData;
        try {
    ...
    private _createTableBody(content: INutritionBoxProductSpecificationData): (JSX.Element | null)[] {
    ...
    private _createDrawerBody(content: INutritionBoxProductSpecificationData): (JSX.Element | null)[] {
