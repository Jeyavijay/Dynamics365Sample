...
import { ProductSpecificationTableRow } from './components/tasty-product-specification-table-stucture';
import { ITastyProductSpecificationData } from './tasty-product-specification.data';
import { displayStyle, ITastyProductSpecificationProps } from './tasty-product-specification.props.autogenerated';
 ...
 */
export interface IProductSpecificationViewProps extends ITastyProductSpecificationProps<{}> {
 ...
 */
export interface IProductSpecificationExtentedProps extends ITastyProductSpecificationProps<ITastyProductSpecificationData> {
 ...
 * @extends {React.Component<ITastyProductSpecificationProps<ITastyProductSpecificationData>>}
 */
@observer
class ProductSpecification extends React.Component<IProductSpecificationExtentedProps, IProductSpecificationState> {
    ...
    public render(): JSX.Element | null {
        let data: ITastyProductSpecificationData;
        try {
    ...
    private _createTableBody(content: ITastyProductSpecificationData): (JSX.Element | null)[] {
    ...
    private _createDrawerBody(content: ITastyProductSpecificationData): (JSX.Element | null)[] {
