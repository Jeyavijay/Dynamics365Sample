...
import { ProductSpecificationTableRow } from './components/sf-product-specification-table-stucture';
import { ISfProductSpecificationData } from './sf-product-specification.data';
import { displayStyle, ISfProductSpecificationProps } from './sf-product-specification.props.autogenerated';
 ...
 */
export interface IProductSpecificationViewProps extends ISfProductSpecificationProps<{}> {
 ...
 */
export interface IProductSpecificationExtentedProps extends ISfProductSpecificationProps<ISfProductSpecificationData> {
 ...
 * @extends {React.Component<ISfProductSpecificationProps<ISfProductSpecificationData>>}
 */
@observer
class ProductSpecification extends React.Component<IProductSpecificationExtentedProps, IProductSpecificationState> {
    ...
    public render(): JSX.Element | null {
        let data: ISfProductSpecificationData;
        try {
    ...
    private _createTableBody(content: ISfProductSpecificationData): (JSX.Element | null)[] {
    ...
    private _createDrawerBody(content: ISfProductSpecificationData): (JSX.Element | null)[] {
