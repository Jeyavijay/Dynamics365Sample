...
import { ProductSpecificationTableRow } from './components/custom-product-specification-table-stucture';
import { ICustomProductSpecificationData } from './custom-product-specification.data';
import { displayStyle, ICustomProductSpecificationProps } from './custom-product-specification.props.autogenerated';
 ...
 */
export interface IProductSpecificationViewProps extends ICustomProductSpecificationProps<{}> {
 ...
 */
export interface IProductSpecificationExtentedProps extends ICustomProductSpecificationProps<ICustomProductSpecificationData> {
 ...
 * @extends {React.Component<ICustomProductSpecificationProps<ICustomProductSpecificationData>>}
 */
@observer
class ProductSpecification extends React.Component<IProductSpecificationExtentedProps, IProductSpecificationState> {
    ...
    public render(): JSX.Element | null {
        let data: ICustomProductSpecificationData;
        try {
    ...
    private _createTableBody(content: ICustomProductSpecificationData): (JSX.Element | null)[] {
    ...
    private _createDrawerBody(content: ICustomProductSpecificationData): (JSX.Element | null)[] {
