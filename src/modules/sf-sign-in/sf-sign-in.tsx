...
import SignInButtonComponent from './components/sf-sign-in-button';
import SignInDescriptionComponent from './components/sf-sign-in-description';
import SignInErrorComponent from './components/sf-sign-in-error';
import SignInInputComponent from './components/sf-sign-in-input';
import SignInLabelComponent from './components/sf-sign-in-label';
import SignInLinkComponent from './components/sf-sign-in-link';
import SignInLoadingIconComponent from './components/sf-sign-in-loading-icon';
import SignInLoadingMessageComponent from './components/sf-sign-in-loading-message';
import SignInTextComponent from './components/sf-sign-in-text';
import { ISfSignInConfig, ISfSignInProps, ISfSignInResources } from './sf-sign-in.props.autogenerated';
 ...
 * @extends {React.Component<ISfSignInProps<ISfSignInData>>}
 */
@observer
class SignIn extends React.Component<ISfSignInProps<ISfSignInConfig>> {
    ...
    constructor(props: ISfSignInProps<ISfSignInConfig>) {
        super(props);
    ...
    public shouldComponentUpdate(nextProps: ISfSignInProps<ISfSignInConfig>, nextState: ISignInViewState): boolean {
    ...
    public render(): JSX.Element {
        const config: ISfSignInConfig = this.props.config || {};
        const resources: ISfSignInResources = this.props.resources || {};
